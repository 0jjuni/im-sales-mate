  ...
  <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4" onClick={onClose}>
    ...
    >
      ...
      <div className="p-5 space-y-3">
        <div className="bg-fuchsia-50/40 border-l-4 border-fuchsia-400 p-3 text-sm text-slate-800 leading-relaxed space-y-1.5">
          <p>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-fuchsia-50/60 border-l-4 border-fuchsia-500 px-4 py-2.5 rounded-r-sm flex items-start gap-2 print:hidden">
        <AlertTriangle className="w-4 h-4 text-fuchsia-600 flex-shrink-0 mt-0.5" />
