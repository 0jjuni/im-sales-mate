    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-9 pr-3 py-2.5 text-sm border border-slate-300 rounded-xl focus:outline-none focus:border-violet-500 focus:ring-1 focus:ring-violet-200"
        />
      </div>

      <div className="space-y-2">
        {filtered.length === 0 && (
          <div className="text-center text-sm text-slate-500 py-8">검색 결과가 없습니다.</div>
        )}
        {filtered.map((f, i) => {
