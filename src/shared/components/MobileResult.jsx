...
export function MobileResult({ amount, label, targetId }) {
  return <div className="mobile-result sticky bottom-3 z-20 flex items-center justify-between gap-3 rounded-xl border border-slate-200 bg-white p-3 shadow-lg lg:hidden print:hidden">
