...
export function buildLibrarySeed() {
  ...
  const posts = [
    ...
    /* 문샷 데일리 — 카드뉴스 이미지(업로드형) */
    {
      ...
      body: "전일 코스피 +0.4% / 코스닥 -0.2%. 반도체가 지수를 끌어올렸습니다. 오늘 카드뉴스로 정리했습니다.",
    ...
    /* 알기 쉬운 세무상식 */
    {
      ...
      body:
        "이자·배당을 합한 금융소득이 연 2,000만원을 넘으면 그 초과분이 다른 소득과 합산돼 누진세율로 과세됩니다(금융소득 종합과세).\n\n" +
        "[창구에서 쉽게 설명하는 법]\n" +
        "· \"2,000만원까지는 15.4%로 끝, 넘으면 다른 소득과 합쳐 세율이 올라갑니다.\"\n" +
        "· 대상이 되면 비과세종합저축·ISA 신규가입이 제한될 수 있다는 점도 함께 안내\n\n" +
        "[상담 연결] 기준에 근접한 고객은 이자 수령 시기 분산, 비과세·분리과세 상품(ISA·저축성보험) 활용을 검토하세요. 고객 진단 화면에서 대상 여부를 바로 확인할 수 있습니다.",
    },
    {
      id: "p_tax_2",
      channelId: "ch_tax",
      ...
      body:
        "부양가족 인적공제는 소득요건(연 소득금액 100만원, 근로소득만 있으면 총급여 500만원 이하)이 핵심입니다.\n\n" +
        "· 따로 사는 부모님도 실제 부양하면 공제 가능(다른 형제가 중복 공제하지 않는지 확인)\n" +
        "· 배우자가 중도 퇴사해 총급여 500만원 이하면 배우자 공제 대상\n" +
        "· 장애인·경로우대 추가공제는 놓치기 쉬우니 함께 점검\n\n" +
        "상담 중 고객이 물어보면 위 세 가지만 짚어줘도 도움이 됩니다.",
    },
  ];
