  ...
  news: [
    {
      ...
      summary:
        "금융통화위원회가 기준금리를 연 2.50%에서 2.75%로 0.25%p 올렸습니다. 물가 상승 압력이 이어지는 가운데 가계부채와 수도권 주택가격 오름세를 함께 고려한 결정으로, 인상 의견은 만장일치였습니다.",
      pbNote:
    ...
    },
    {
      ...
      summary:
        "퇴직연금 도입을 사업장 규모에 따라 단계적으로 의무화하는 작업이 본격화됐습니다. 수익률을 끌어올리기 위한 기금형 퇴직연금 도입과 연금 형태 수령 확대도 함께 추진됩니다.",
      pbNote:
    ...
    },
    {
      ...
      importance: "normal",
      category: "예금·수신",
      headline: "시중은행 정기예금 최고금리 3%대 재진입",
      summary:
        "기준금리 인상 이후 주요 은행의 12개월 정기예금 최고금리가 다시 3%대에 올라섰습니다. 특판·우대조건에 따라 은행별 편차가 큽니다.",
      pbNote:
        "만기 도래 고객에게 재예치를 제안하기 좋은 시점입니다. 우대조건(급여이체·카드실적) 충족 여부를 먼저 확인해 실수령 금리를 안내하세요.",
      source: "은행연합회 예금금리 공시",
    },
    {
      id: "n7",
      date: "2026-08-14",
      importance: "normal",
      category: "투자·펀드",
      headline: "미국 기술주 강세에 해외주식형 펀드로 자금 유입 지속",
      summary:
        "반도체·AI 관련 미국 대형주 강세가 이어지며 해외주식형 펀드·ETF로 자금 유입이 계속되고 있습니다. 환율·밸류에이션 부담을 지적하는 신중론도 함께 나옵니다.",
      pbNote:
        "쏠림에 유의해 적립식·분산 관점으로 안내하세요. 투자성향 확인 후 성향에 맞는 위험등급 상품만 제시하고, 환헤지 여부도 함께 설명하면 좋습니다.",
      source: "금융투자협회 · 자산운용 동향",
    },
    {
      id: "n8",
      date: "2026-08-12",
      importance: "normal",
      category: "상속증여",
      headline: "유산취득세 전환 논의 — 상속 상담 문의 증가",
      summary:
        "상속세 과세 방식을 유산취득세로 바꾸는 방안이 논의되면서 고액 자산가의 사전증여·상속 설계 문의가 늘고 있습니다. 확정 전 논의 단계입니다.",
      pbNote:
        "확정 전 사항임을 분명히 하되, 사전증여·연금 활용 등 절세 설계 니즈를 파악해 두세요. 세무 상담이 필요한 고객은 전문가 연계로 이어 주세요.",
      source: "기획재정부 세제개편 논의",
    },
    {
      id: "n9",
      date: "2026-08-11",
      importance: "normal",
      category: "금리",
      headline: "미 연준 금리 동결 — 연내 인하 기대 후퇴",
      summary:
        "미국 연방준비제도가 정책금리를 동결하며 물가 재상승 경계감을 나타냈습니다. 연내 인하 기대가 후퇴하면서 원/달러 환율과 시장금리가 영향을 받았습니다.",
      pbNote:
        "환율 변동에 민감한 해외투자 고객에게 환위험을 함께 설명하세요. 금리 향방이 불확실한 만큼 만기 분산·단기 상품 병행도 대안으로 제시할 수 있습니다.",
      source: "미 연준(FOMC)",
    },
  ],
};
